...
function drawPageDecorations(pdf, pageNum, totalPages, sectionTitle) {
...
function drawRequisitionsPage() {
  ...
  doc.setFontSize(11);
  doc.setTextColor(COLORS.dark);
  doc.text("UNDERSTANDING STATUS BAR CHECKPOINTS:", 15, 178);
...
try {
  ...
  // Use arraybuffer rather than default binary string for direct saving to prevent character encoding issues
