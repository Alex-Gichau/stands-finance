                ...
                >
                  ...
                  <div className="flex flex-row md:flex-col items-center gap-2 overflow-hidden shrink-0 border-t md:border-t-0 pt-3 md:pt-0 border-slate-100 w-full md:w-auto">
                    ...
                    <button
                      ...
                      className="flex-1 md:w-full px-3 py-2 bg-slate-100 hover:bg-slate-200 text-slate-600 text-[10px] font-bold uppercase rounded-lg transition-colors border border-slate-200"
                    >
