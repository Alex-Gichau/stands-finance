        ...
        <AnimatePresence>
          {showGoogleOneTap && (
            <motion.div
              ...
              className="fixed top-4 right-4 z-50 w-[320px] sm:w-[360px] bg-white rounded-2xl shadow-2xl border border-slate-200/90 text-slate-900 overflow-hidden font-sans select-none"
            >
              {/* Header */}
              <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100 bg-white">
                <div className="flex items-center gap-2.5 min-w-0 pr-2">
                  ...
                  <span className="text-[13px] font-semibold text-slate-800 truncate">
                    Sign in to standrews.org with Google
                  </span>
                </div>
                <button
                  type="button"
                  ...
                  title="Close Google Sign In prompt"
                >
                  <X size={16} />
                </button>
              </div>
